...
import static proychat.ProyChat.idUsuario;
...
public class InterfazChat extends javax.swing.JFrame {
    ClientChat cc;
    ArrayList<ChatInt> chatinterfaces = new ArrayList<ChatInt>();
    Usuario user;
     ...
     */ 
    private InterfazChat() {
        initComponents();
    }

    public InterfazChat(String usuario, String ip) {
        user = SQL_Usuario.getUsuario(usuario);
        System.out.println("99999"+user);
         cc = new ClientChat(SQL_Usuario.getUsuario(user.getIdUsuario().toString()),ip);
        initComponents();
        for (Chat chat : SQL_Chat.getChats()) {
            System.out.println("chat " + chat);
            jTabbedPane1.add(new ChatInt(user, chat,cc));
